...
* Create a [custom build script][custom-build-script]:
...
* Run `GitVersion --output buildserver`: this will cause MyGet Build Services to
  ...
  generated by GitVersion and apply this [MyGet Environment Variable][myget-environment-variable]
...
`call %GitVersion% --update-assembly-info true`.
:::

Also check [docs.myget.org][docs-myget-org]
for the latest full info.

[custom-build-script]: https://docs.myget.org/docs/reference/custom-build-scripts

[by-convention]: https://docs.myget.org/docs/reference/build-services#Pre-_and_post-build_steps

[myget-environment-variable]: https://docs.myget.org/docs/reference/build-services#Available_Environment_Variables

[docs-myget-org]: https://docs.myget.org/docs/reference/build-services#GitVersion_and_Semantic_Versioning
