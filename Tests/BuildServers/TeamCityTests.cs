...
public class TeamCityTests
{
    ...
    public void EscapeValues()
    {
        ...
        Assert.AreEqual("##teamcity[setParameter name='system.GitFlowVersion.Foo' value='0.8.0-unstable568 Branch:|'develop|' Sha:|'ee69bff1087ebc95c6b43aa2124bd58f5722e0cb|'']", tcVersion[0]);
