...
public class LegacyArgumentParserTests : TestBase
{
    ...
    {
        var arguments = this.argumentParser.ParseArguments("-dynamicRepoLocation /path/to/repo");
        arguments.ClonePath.ShouldBe("/path/to/repo");
    }
    ...
    [TestCase("/path/to/custom-config.yaml")]
