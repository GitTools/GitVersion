...
namespace GitVersion.MSBuildTask.Tests
{
    ...
    public class GitVersionTaskDirectoryTests : TestBase
    {
        ...
        public void FindsGitDirectory()
        {
            try
            {
                var options = Options.Create(new Arguments { TargetPath = workDirectory, NoFetch = true });
        ...
        public void FindsGitDirectoryInParent()
        {
            ...
            try
            {
                var options = Options.Create(new Arguments { TargetPath = childDir, NoFetch = true });
