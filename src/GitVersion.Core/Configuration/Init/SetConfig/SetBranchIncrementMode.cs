...
public class SetBranchIncrementMode : ConfigInitWizardStep
{
    ...
    protected override string GetPrompt(Model.Configurations.Configuration config, string workingDirectory) => $@"What do you want the increment mode for {this.name} to be?
