...
namespace GitVersion.Extensions
{
    ...
    {
        public static string GetAssemblyVersion(this SemanticVersion sv, AssemblyVersioningScheme scheme) => scheme switch
        {
        ...
        public static string GetAssemblyFileVersion(this SemanticVersion sv, AssemblyFileVersioningScheme scheme) => scheme switch
        {
