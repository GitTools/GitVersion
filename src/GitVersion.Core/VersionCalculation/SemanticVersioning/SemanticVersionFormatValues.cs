...
namespace GitVersion
{
    public class SemanticVersionFormatValues
    {
        ...
        public string? PreReleaseTagWithDash => semver.PreReleaseTag?.HasTag() == true ? "-" + semver.PreReleaseTag : null;

        public string? PreReleaseLabel => semver.PreReleaseTag?.HasTag() == true ? semver.PreReleaseTag.Name : null;

        public string? PreReleaseLabelWithDash => semver.PreReleaseTag?.HasTag() == true ? "-" + semver.PreReleaseTag.Name : null;

        public string? PreReleaseNumber => semver.PreReleaseTag?.HasTag() == true ? semver.PreReleaseTag.Number.ToString() : null;
        ...
        public string? NuGetPreReleaseTagV2 => semver.PreReleaseTag?.HasTag() == true ? semver.PreReleaseTag?.ToString("lp")?.ToLower() : null;
