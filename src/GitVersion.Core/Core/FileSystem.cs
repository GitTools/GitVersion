...
namespace GitVersion
{
    public class FileSystem : IFileSystem
    {
        ...
        public void WriteAllText(string file, string fileContents, Encoding encoding) => File.WriteAllText(file, fileContents, encoding);

        public IEnumerable<string> DirectoryEnumerateFiles(string directory, string searchPattern, SearchOption searchOption) => Directory.EnumerateFiles(directory, searchPattern, searchOption);
