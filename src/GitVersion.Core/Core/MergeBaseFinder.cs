...
internal class MergeBaseFinder(IRepositoryStore repositoryStore, ILogger<MergeBaseFinder> logger)
{
    private readonly ILogger<MergeBaseFinder> logger = logger.NotNull();
