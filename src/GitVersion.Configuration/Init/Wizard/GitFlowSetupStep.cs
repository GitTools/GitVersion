...
internal class GitFlowSetupStep(IConsole console, IFileSystem fileSystem, ILog log, IConfigInitStepFactory stepFactory)
    : GlobalModeSetting(console, fileSystem, log, stepFactory)
{
