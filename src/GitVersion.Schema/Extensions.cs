...
internal static class Extensions
{
    ...
    extension(JsonSchema jsonSchema)
    {
        ...
        public void WriteV7ConfigurationToFile(string outputFileName)
        {
            ...
            {
                [ConfigurationDocumentMapper.WorkflowPropertyName] = properties[ConfigurationDocumentMapper.WorkflowPropertyName]?.DeepClone(),
    ...
    private static JsonObject CreateSection(JsonObject source, bool output)
    {
        ...
        {
            if (propertySchema is null || propertyName == ConfigurationDocumentMapper.WorkflowPropertyName)
            {
                continue;
            }
