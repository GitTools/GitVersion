...
internal partial class TrunkBasedScenariosWithAGitHubFlow
{
    ...
    public class GivenAMainBranchWithTwoCommitsWhenSecondCommitTaggedAsPreRelease
    {
        ...
        [TestCase(IncrementStrategy.Minor, null, ExpectedResult = "0.2.0-4")]
        [TestCase(IncrementStrategy.Major, null, ExpectedResult = "0.2.0-4")]

        [TestCase(IncrementStrategy.None, "", ExpectedResult = "0.2.0-4")]
        [TestCase(IncrementStrategy.Patch, "", ExpectedResult = "0.2.0-4")]
        [TestCase(IncrementStrategy.Minor, "", ExpectedResult = "0.2.0-4")]
        [TestCase(IncrementStrategy.Major, "", ExpectedResult = "0.2.0-4")]
        ...
        [TestCase(IncrementStrategy.None, "bar", ExpectedResult = "0.2.0-bar.2+1")]
