...
public class DocumentationSamples : TestBase
{
    ...
    public void GitFlowFeatureBranch()
    {
        ...
        fixture.SequenceDiagram.Participant(MainBranch);
    ...
    public void GitFlowMajorRelease()
    {
        ...
        fixture.Checkout(MainBranch);
        fixture.AssertFullSemver("2.0.0+0"); // It has been tagged with 2.0.0-beta.1 why would you expect the version 2.0.0+0 instead of 2.0.0-beta.2+2?
    ...
    public void GitFlowSupportHotfixRelease()
    {
        ...
        fixture.Repository.MakeACommit();
        fixture.BranchTo("develop");
        fixture.SequenceDiagram.NoteOver("Create 2.0.0 release and complete", "develop", MainBranch);
        fixture.Checkout(MainBranch);
        fixture.ApplyTag("2.0.0");
    ...
    public void GitFlowSupportMinorRelease()
    {
        ...
        fixture.Checkout("1.3.0");
        fixture.BranchToFromTag("support/1.x", "1.3.0", MainBranch, "support");
        fixture.SequenceDiagram.NoteOver("Create 1.3.1 release and complete", MainBranch, "support/1.x");
        fixture.Repository.MakeACommit();
        fixture.ApplyTag("1.3.1");
        ...
        fixture.AssertFullSemver("1.4.0+0"); // It has been tagged with 1.4.0-beta.1 why would you expect the version 1.4.0+0 instead of 1.4.0-beta.2+1?
