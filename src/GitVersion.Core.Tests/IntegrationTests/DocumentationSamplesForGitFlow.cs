...
public class DocumentationSamplesForGitFlow
{
    ...
    public void FeatureFromMainBranch(bool withPullRequestIntoMain)
    {
        ...
        DocumentationDiagramWriter.Write(
            ...
            $"{nameof(DocumentationSamplesForGitFlow)}_{nameof(FeatureFromMainBranch)}",
    ...
    public void FeatureFromMainBranchWithMainline(bool withPullRequestIntoMain)
    {
        ...
        DocumentationDiagramWriter.Write(
            fixture.SequenceDiagram,
            $"{nameof(DocumentationSamplesForGitFlow)}_{nameof(FeatureFromMainBranchWithMainline)}",
            withPullRequestIntoMain);
    }
    ...
    public void FeatureFromDevelopBranch(bool withPullRequestIntoDevelop)
    {
        ...
        DocumentationDiagramWriter.Write(
            fixture.SequenceDiagram,
            $"{nameof(DocumentationSamplesForGitFlow)}_{nameof(FeatureFromDevelopBranch)}",
            withPullRequestIntoDevelop);
    }
    ...
    public void HotfixBranch(bool withPullRequestIntoMain)
    {
        ...
        DocumentationDiagramWriter.Write(
            fixture.SequenceDiagram,
            $"{nameof(DocumentationSamplesForGitFlow)}_{nameof(HotfixBranch)}",
            withPullRequestIntoMain);
    }
    ...
    public void VersionedHotfixBranch(bool withPullRequestIntoMain)
    {
        ...
        DocumentationDiagramWriter.Write(
            fixture.SequenceDiagram,
            $"{nameof(DocumentationSamplesForGitFlow)}_{nameof(VersionedHotfixBranch)}",
            withPullRequestIntoMain);
    }
    ...
    public void ReleaseBranch(bool withPullRequestIntoMain)
    {
        ...
        DocumentationDiagramWriter.Write(
            fixture.SequenceDiagram,
            $"{nameof(DocumentationSamplesForGitFlow)}_{nameof(ReleaseBranch)}",
            withPullRequestIntoMain);
    }
    ...
    public void VersionedReleaseBranch(bool withPullRequestIntoMain)
    {
        ...
        DocumentationDiagramWriter.Write(
            fixture.SequenceDiagram,
            $"{nameof(DocumentationSamplesForGitFlow)}_{nameof(VersionedReleaseBranch)}",
            withPullRequestIntoMain);
    }
    ...
    public void DevelopBranch(bool withPullRequestIntoMain)
    {
        ...
        DocumentationDiagramWriter.Write(
            fixture.SequenceDiagram,
            $"{nameof(DocumentationSamplesForGitFlow)}_{nameof(DevelopBranch)}",
            withPullRequestIntoMain);
    }
    ...
    public void SupportBranch(bool withPullRequestIntoSupport)
    {
        ...
        DocumentationDiagramWriter.Write(
            fixture.SequenceDiagram,
            $"{nameof(DocumentationSamplesForGitFlow)}_{nameof(SupportBranch)}",
            withPullRequestIntoSupport);
    }
