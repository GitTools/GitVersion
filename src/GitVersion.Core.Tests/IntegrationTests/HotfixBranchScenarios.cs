...
public class HotfixBranchScenarios : TestBase
{
    ...
    private static RepositoryFixtureBase GivenIHaveALocalRepositoryWithAnHotFixMergedInAPullRequestBranch()
    {
    ...
    private static RepositoryFixtureBase GivenIHaveALocalRepositoryWithAFeatureMergedInAPullRequestBranch()
    {
        var fixture = new EmptyRepositoryFixture();
    ...
    public static Config GivenIHaveContinuousDeploymentConfigurationWithAMinorIncrementStrategyForMainBranch() => new()
    {
        VersioningMode = VersioningMode.ContinuousDeployment,
