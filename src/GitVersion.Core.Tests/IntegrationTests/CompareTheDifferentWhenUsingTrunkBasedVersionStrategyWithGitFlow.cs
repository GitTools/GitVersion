...
public class CompareTheDifferentWhenUsingTrunkBasedVersionStrategyWithGitFlow
{
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureFeature(bool useTrunkBased)
    {
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureMergeMainToFeature(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureReleaseAndFeatureBranch(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    public void EnsureReleaseAndFeatureBranch(bool useTrunkBased, string releaseBranch)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureReleaseBranch(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(true, "release/0.0.2")]
    [TestCase(true, "release/0.1.0")]
    public void EnsureReleaseBranch(bool useTrunkBased, string releaseBranch)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureFeatureDevelopmentWithDevelopBranch(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureFeatureDevelopmentWithDevelopBranchFast(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureDevelopmentWithMainBranchFast(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureBugFixWithMainBranch(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureBugFixWithDevelopBranch(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureBugFixWithDevelopBranchFast(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureFeatureDevelopmentWithReleaseNextBranchFast(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
    ...
    [TestCase(false)]
    [TestCase(true)]
    public void EnsureFeatureDevelopmentWithRelease100Branch(bool useTrunkBased)
    {
        var builder = useTrunkBased
            ? configurationBuilder.WithVersionStrategy(VersionStrategies.TrunkBased)
            : configurationBuilder;
