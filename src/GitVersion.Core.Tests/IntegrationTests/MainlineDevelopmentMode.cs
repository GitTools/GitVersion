...
{
    private readonly Model.Configurations.Configuration configuration = new() { VersioningMode = VersioningMode.Mainline };
    ...
    {
        var currentConfig = new Model.Configurations.Configuration { VersioningMode = VersioningMode.Mainline, Branches = new Dictionary<string, BranchConfiguration> { { "feature", new BranchConfiguration { VersioningMode = VersioningMode.ContinuousDeployment, Increment = IncrementStrategy.Minor } } } };
