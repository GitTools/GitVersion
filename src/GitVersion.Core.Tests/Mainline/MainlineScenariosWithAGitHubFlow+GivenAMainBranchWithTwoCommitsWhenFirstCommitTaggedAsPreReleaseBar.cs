...
internal partial class MainlineScenariosWithAGitHubFlow
{
    ...
    public class GivenAMainBranchWithTwoCommitsWhenFirstCommitTaggedAsPreReleaseBar
    {
        ...
        [TestCase(IncrementStrategy.Minor, null, ExpectedResult = "0.1.0-bar+1")]
        [TestCase(IncrementStrategy.Major, null, ExpectedResult = "1.0.0-bar+1")]
        ...
        [TestCase(IncrementStrategy.None, "foo", ExpectedResult = "0.0.3-foo.2+1")]
        ...
        [TestCase(IncrementStrategy.Patch, "bar", ExpectedResult = "0.0.4-bar+1")]
        [TestCase(IncrementStrategy.Minor, "bar", ExpectedResult = "0.1.0-bar+1")]
