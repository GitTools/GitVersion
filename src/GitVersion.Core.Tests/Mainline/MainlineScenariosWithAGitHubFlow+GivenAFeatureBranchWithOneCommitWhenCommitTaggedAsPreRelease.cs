...
internal partial class MainlineScenariosWithAGitHubFlow
{
    ...
    public class GivenAFeatureBranchWithOneCommitWhenCommitTaggedAsPreRelease
    {
        ...
        [TestCase(IncrementStrategy.Major, null, ExpectedResult = "0.0.0-5+0")]

        [TestCase(IncrementStrategy.None, "", ExpectedResult = "0.0.0-5+0")]
        [TestCase(IncrementStrategy.Patch, "", ExpectedResult = "0.0.0-5+0")]
        [TestCase(IncrementStrategy.Minor, "", ExpectedResult = "0.0.0-5+0")]
        [TestCase(IncrementStrategy.Major, "", ExpectedResult = "0.0.0-5+0")]
