...
internal partial class MainlineScenariosWithAGitHubFlow
{
    ...
    public class GivenAMainBranchWithTwoCommitsWhenFirstCommitTaggedAsStable
    {
        ...
        [TestCase(IncrementStrategy.None, "", ExpectedResult = "0.0.3-1+1")]
        ...
        [TestCase(IncrementStrategy.None, "foo", ExpectedResult = "0.0.3-foo.1+1")]
        ...
        [TestCase(IncrementStrategy.None, "bar", ExpectedResult = "0.0.3-bar.1+1")]
