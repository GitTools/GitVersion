...
internal partial class MainlineScenariosWithAGitHubFlow
{
    ...
    public class GivenAMainBranchWithTwoCommitsWhenFirstCommitHasBumpMessagePatch
    {
        ...
        [TestCase(IncrementStrategy.None, "", ExpectedResult = "0.0.1-2+1")]
        ...
        [TestCase(IncrementStrategy.None, "foo", ExpectedResult = "0.0.1-foo.2+1")]
        ...
        [TestCase(IncrementStrategy.None, "bar", ExpectedResult = "0.0.1-bar.2+1")]
