...
internal partial class MainlineScenariosWithAGitHubFlow
{
    ...
    public class GivenAMainBranchWithTwoCommitsWhenSecondCommitHasBumpMessagePatch
    {
        ...
        [TestCase(IncrementStrategy.None, "", ExpectedResult = "0.0.1-1+1")]
        ...
        [TestCase(IncrementStrategy.None, "foo", ExpectedResult = "0.0.1-foo.1+1")]
        ...
        [TestCase(IncrementStrategy.None, "bar", ExpectedResult = "0.0.1-bar.1+1")]
