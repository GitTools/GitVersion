...
public class LabelTokenizerTests
{
    ...
    [TestCase("\"Pattern \"", "Pattern ")]
    [TestCase("\"Pat\\\"tern\"", "Pat\"tern")]
    public void ParseTokens_ValidLiterals_ReturnsValid(string input, params string[] expected)
    {
    ...
    [TestCase("Pattern\"")]
    [TestCase("Pat\"tern")]
    public void ParseTokens_InvalidLiterals_Throws(string input)
    {
        var tokenizer = new LabelTokenizer(input);
    ...
    public void ParseTokens_ValidIdentifiers_ReturnsValid(string input, params string[] expected)
    {
        var tokenizer = new LabelTokenizer(input);
        var tokens = tokenizer.ParseTokens()
            .Select(x => x.Name)
    ...
    public void ParseTokens_MalformedIdentifiers_Throws(string input)
    {
        var tokenizer = new LabelTokenizer(input);
