    ...
    : IArgumentParser
{
        ...
        TelemetryCollectionBuilder telemetry)
    {
        ...
        MapUpdateProjectFiles(arguments, parseResult, options, telemetry);
        MapEnsureAssemblyInfo(arguments, parseResult, options, telemetry);
    ...
    private static void MapOutputAndDisplay(
        Arguments arguments,
        ParseResult parseResult,
        CommandOptions options,
        TelemetryCollectionBuilder telemetry)
        ...
        TelemetryCollectionBuilder telemetry)
    {
        ...
        ApplyUpdateAssemblyInfo(arguments, values);
    ...
    private static void ApplyUpdateAssemblyInfo(Arguments arguments, string[]? values)
    {
        ...
        AddAssemblyInfoFileNames(arguments, values);
    }

    private static void AddAssemblyInfoFileNames(Arguments arguments, string[]? values)
    {
        if (values == null)
        {
            return;
    ...
    private static void MapUpdateProjectFiles(
        Arguments arguments,
        ParseResult parseResult,
        CommandOptions options,
        TelemetryCollectionBuilder telemetry)
    {
        ...
        AddAssemblyInfoFileNames(arguments, projectFiles);
    ...
    private static void MapEnsureAssemblyInfo(
        Arguments arguments,
        ParseResult parseResult,
        CommandOptions options,
        TelemetryCollectionBuilder telemetry)
